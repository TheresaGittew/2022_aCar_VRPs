...
scenario = Scenario(25, lower_bound=0, upper_bound=300, GIS_inputs=input_gis)
...
io_excel = IOExcel(scenario, root_directory='04-04-CaseStudy', add_to_folder_title='_', title_excel_to_create_or_read="DecisionvariableValues.xlsx",
...
# # post processing
excel_for_processed_data = IOExcel(scenario, root_directory='04-04-CaseStudy', add_to_folder_title='_', title_excel_to_create_or_read="DecisionvariableValues_PP.xlsx",
                     titles_keys_per_dec_var=(['Customer', 'Vehicle', 'Day'], ['O', 'D', 'Vehicle', 'Day'],
                                           ['Customer', 'Vehicle', 'Day', 'ServiceType'],['ConfigType','Vehicle']), output_tab_names=('Z', 'Y', 'Q','U'))
